...
import { BonLivraisonView } from '../types';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-card rounded-xl border border-border shadow-sm overflow-hidden min-h-[500px]">
        ...
        <div className="flex border-b border-border">
          ...
          >
            <Gift size={18} /> Don de Fin de Cession
          </button>
        </div>
        ...
        <div className="p-0">
          ...
          {activeTab === 'fin_cession' && (
            <div className="flex flex-col items-center justify-center p-12 text-center">
              ...
              <h3 className="text-lg font-semibold text-foreground">Vue Don de Fin de Cession</h3>
              <p className="text-muted-foreground max-w-md mt-2">
                Cette vue est en cours de développement. Les données seront disponibles prochainement.
              </p>
            </div>
          )}
        </div>
